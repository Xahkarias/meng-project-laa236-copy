...
void test_POA_basic_sw_120() {
    ...
    graph.nodeLabels[80] = 'A';
    graph.nodeLabels[81] = 'F';
    graph.nodeLabels[82] = 'B';
    graph.nodeLabels[83] = 'C';
    graph.nodeLabels[84] = 'D';
    graph.nodeLabels[85] = 'E';
    graph.nodeLabels[86] = 'E';
    graph.nodeLabels[87] = 'E';
    graph.nodeLabels[88] = 'E';
    graph.nodeLabels[89] = 'E';
    graph.nodeLabels[90] = 'A';
    graph.nodeLabels[91] = 'F';
    graph.nodeLabels[92] = 'B';
    graph.nodeLabels[93] = 'C';
    graph.nodeLabels[94] = 'D';
    graph.nodeLabels[95] = 'E';
    graph.nodeLabels[96] = 'E';
    graph.nodeLabels[97] = 'E';
    graph.nodeLabels[98] = 'E';
    graph.nodeLabels[99] = 'E';
    graph.nodeLabels[100] = 'A';
    graph.nodeLabels[101] = 'F';
    graph.nodeLabels[102] = 'B';
    graph.nodeLabels[103] = 'C';
    graph.nodeLabels[104] = 'D';
    graph.nodeLabels[105] = 'E';
    graph.nodeLabels[106] = 'E';
    graph.nodeLabels[107] = 'E';
    graph.nodeLabels[108] = 'E';
    graph.nodeLabels[109] = 'E';
    graph.nodeLabels[110] = 'A';
    graph.nodeLabels[111] = 'F';
    graph.nodeLabels[112] = 'B';
    graph.nodeLabels[113] = 'C';
    graph.nodeLabels[114] = 'D';
    graph.nodeLabels[115] = 'E';
    graph.nodeLabels[116] = 'E';
    graph.nodeLabels[117] = 'E';
    graph.nodeLabels[118] = 'E';
    graph.nodeLabels[119] = 'E';
    ...
    graph.nodeNumEdges[80] = 1; graph.nodeIncomingEdges[0][80] = 79;
    graph.nodeNumEdges[81] = 1; graph.nodeIncomingEdges[0][81] = 80;
    graph.nodeNumEdges[82] = 1; graph.nodeIncomingEdges[0][82] = 81;
    graph.nodeNumEdges[83] = 1; graph.nodeIncomingEdges[0][83] = 82;
    graph.nodeNumEdges[84] = 1; graph.nodeIncomingEdges[0][84] = 83;
    graph.nodeNumEdges[85] = 1; graph.nodeIncomingEdges[0][85] = 84;
    graph.nodeNumEdges[86] = 1; graph.nodeIncomingEdges[0][86] = 85;
    graph.nodeNumEdges[87] = 1; graph.nodeIncomingEdges[0][87] = 86;
    graph.nodeNumEdges[88] = 1; graph.nodeIncomingEdges[0][88] = 87;
    graph.nodeNumEdges[89] = 1; graph.nodeIncomingEdges[0][89] = 88;
    graph.nodeNumEdges[90] = 1; graph.nodeIncomingEdges[0][90] = 89;
    graph.nodeNumEdges[91] = 1; graph.nodeIncomingEdges[0][91] = 90;
    graph.nodeNumEdges[92] = 1; graph.nodeIncomingEdges[0][92] = 91;
    graph.nodeNumEdges[93] = 1; graph.nodeIncomingEdges[0][93] = 92;
    graph.nodeNumEdges[94] = 1; graph.nodeIncomingEdges[0][94] = 93;
    graph.nodeNumEdges[95] = 1; graph.nodeIncomingEdges[0][95] = 94;
    graph.nodeNumEdges[96] = 1; graph.nodeIncomingEdges[0][96] = 95;
    graph.nodeNumEdges[97] = 1; graph.nodeIncomingEdges[0][97] = 96;
    graph.nodeNumEdges[98] = 1; graph.nodeIncomingEdges[0][98] = 97;
    graph.nodeNumEdges[99] = 1; graph.nodeIncomingEdges[0][99] = 98;
    graph.nodeNumEdges[100] = 1; graph.nodeIncomingEdges[0][100] = 99;
    graph.nodeNumEdges[101] = 1; graph.nodeIncomingEdges[0][101] = 100;
    graph.nodeNumEdges[102] = 1; graph.nodeIncomingEdges[0][102] = 101;
    graph.nodeNumEdges[103] = 1; graph.nodeIncomingEdges[0][103] = 102;
    graph.nodeNumEdges[104] = 1; graph.nodeIncomingEdges[0][104] = 103;
    graph.nodeNumEdges[105] = 1; graph.nodeIncomingEdges[0][105] = 104;
    graph.nodeNumEdges[106] = 1; graph.nodeIncomingEdges[0][106] = 105;
    graph.nodeNumEdges[107] = 1; graph.nodeIncomingEdges[0][107] = 106;
    graph.nodeNumEdges[108] = 1; graph.nodeIncomingEdges[0][108] = 107;
    graph.nodeNumEdges[109] = 1; graph.nodeIncomingEdges[0][109] = 108;
    graph.nodeNumEdges[110] = 1; graph.nodeIncomingEdges[0][110] = 109;
    graph.nodeNumEdges[111] = 1; graph.nodeIncomingEdges[0][111] = 110;
    graph.nodeNumEdges[112] = 1; graph.nodeIncomingEdges[0][112] = 111;
    graph.nodeNumEdges[113] = 1; graph.nodeIncomingEdges[0][113] = 112;
    graph.nodeNumEdges[114] = 1; graph.nodeIncomingEdges[0][114] = 113;
    graph.nodeNumEdges[115] = 1; graph.nodeIncomingEdges[0][115] = 114;
    graph.nodeNumEdges[116] = 1; graph.nodeIncomingEdges[0][116] = 115;
    graph.nodeNumEdges[117] = 1; graph.nodeIncomingEdges[0][117] = 116;
    graph.nodeNumEdges[118] = 1; graph.nodeIncomingEdges[0][118] = 117;
    graph.nodeNumEdges[119] = 1; graph.nodeIncomingEdges[0][119] = 118;
