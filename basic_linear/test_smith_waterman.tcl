...
set project_name "project_smith_waterman_basic_linear"
set top_function "smith_waterman_basic_linear"
...
# Add source files
add_files ../smith_waterman_basic_linear.cpp
add_files ../smith_waterman_basic_linear.hpp
add_files ../smith_waterman_basic_linear_tb.cpp -tb
...
# run using `vitis_hls -f ../test_smith_waterman.tcl`